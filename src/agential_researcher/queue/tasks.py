...
@celery_app.task(bind=True, name="src.agential_researcher.queue.tasks.enqueue_job_task", autoretry_for=(Exception,), retry_kwargs={'max_retries': 3}, retry_backoff=True, retry_backoff_max=700, retry_jitter=True)
...
@celery_app.task(bind=True, name="src.agential_researcher.queue.tasks.summarize_task", autoretry_for=(Exception,), retry_kwargs={'max_retries': 3}, retry_backoff=True, retry_backoff_max=700, retry_jitter=True)
...
@celery_app.task(name="src.agential_researcher.queue.tasks.embed_task", autoretry_for=(Exception,), retry_kwargs={'max_retries': 3}, retry_backoff=True, retry_backoff_max=700, retry_jitter=True)
...
@celery_app.task(name="src.agential_researcher.queue.tasks.ocr_task", autoretry_for=(Exception,), retry_kwargs={'max_retries': 3}, retry_backoff=True, retry_backoff_max=700, retry_jitter=True)
...
@celery_app.task(name="src.agential_researcher.queue.tasks.vlm_task", autoretry_for=(Exception,), retry_kwargs={'max_retries': 3}, retry_backoff=True, retry_backoff_max=700, retry_jitter=True)
...
@celery_app.task(name="src.agential_researcher.queue.tasks.backfill_task", autoretry_for=(Exception,), retry_kwargs={'max_retries': 3}, retry_backoff=True, retry_backoff_max=700, retry_jitter=True)
...
@celery_app.task(name="src.agential_researcher.queue.tasks.maintenance_task", autoretry_for=(Exception,), retry_kwargs={'max_retries': 3}, retry_backoff=True, retry_backoff_max=700, retry_jitter=True)
